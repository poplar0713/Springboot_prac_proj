...
@Repository
public class XmlMovieReader extends AbstractMetadataSystemMovieReader implements MovieReader {
	...
	public List<Movie> loadMovies() {
		try {
			...
			throw new ApplicationException("failed to load movie data", e);
		}
	}
